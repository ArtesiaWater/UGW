...
def get_ml_layer_dataset_struc(raw_ds=None,
    ...
    ml_layer_ds = get_cache_netcdf(use_cache, cachedir, fname_netcdf,
...
def get_resampled_ml_layer_ds_struc(raw_ds=None,
    ...
    ml_layer_ds = mgrid.resample_dataset_to_structured_grid(raw_ds, extent,
                                                            delr, delc,
                                                            kind=kind)
...
def get_resampled_ml_layer_ds_unstruc(raw_ds=None,
    ...
    ml_layer_ds = mgrid.resample_dataset_to_unstructured_grid(
        raw_ds, gridprops)
